...
scriptEntry utyOptionsList[] =
{
  ...
  {"\n[New HWSDL Options]\n", scriptSetStringCB, &filecfgblankspace},
    ...
    {"RenderSpaceDustEnable",               scriptSetBool,     &opRenderSpaceDustEnable         },
    {"RenderSpaceDustDensity",              scriptSetUdwordCB, &opRenderSpaceDustDensity        },
    {"RenderShaderRealtimeEditEnable",      scriptSetBool,     &opRenderShaderReload            },
    {"RenderShaderRealtimeEditNoWarn",      scriptSetBool,     &opRenderShaderReloadNoWarn      },
